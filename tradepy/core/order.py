...
OrderStatus = Literal[
    "created", "pending", "filled", "cancelled", "unknown", "invalid"
]
...
class Order(BaseModel):
    ...
    def set_sell_remark(
        ...
        self.tags["sell_remark"] = (
            f"{action_code}:{price:.2f},{vol},{pct_chg:.2f}"
        )

    def get_sell_remark(self, raw: bool = True) -> SellRemark | str:
